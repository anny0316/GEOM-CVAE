...
def generate_image_representation(smile,y,id):
    ...
    if mol is not None:
        ...
        path = saveImageFromCoords(coords_arr, i=id)
...
def gather_fn(in_data):
    ...
    only_y = y
    condition_f = []
    protein_ori_f = np.load("/home/project/gMol/data/protein/2Q6D_ABC_/p1_input_feat.npy")
    ...
    condition_f = torch.Tensor(condition_f)
